  ...
  */
         public final class QueryUtils {
           ...
           /** Sample JSON response for a USGS query */
             ...
             /**
 29      * Create a private constructor because no one should ever create a {@link QueryUtils} object.
 30      * This class is only meant to hold static variables and methods, which can be accessed
 31      * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
 32      */
             private QueryUtils() {
             }
            ...
            /**
 37      * Return a list of {@link Earthquake} objects that has been built up from
 38      * parsing a JSON response.
 39      */
